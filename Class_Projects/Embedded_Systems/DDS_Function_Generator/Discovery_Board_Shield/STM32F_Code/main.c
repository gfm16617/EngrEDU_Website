...
uint8_t gTXData[UART_BUFFER_SIZE];
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : BOOT1_Pin SW_Mode_Pin SW_Start_Stop_Pin */
  GPIO_InitStruct.Pin = BOOT1_Pin|SW_Mode_Pin|SW_Start_Stop_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
