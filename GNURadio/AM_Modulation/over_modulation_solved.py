...
class over_modulation_solved(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AM Over Modulation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AM Over Modulation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "over_modulation_solved")
        ...
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 20, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_0, 0), (self.blocks_add_const_vxx_0, 0))
...
def main(top_block_cls=over_modulation_solved, options=None):
