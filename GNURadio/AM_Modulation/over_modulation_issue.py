...
class over_modulation_issue(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "over_modulation_issue")
...
def main(top_block_cls=over_modulation_issue, options=None):
