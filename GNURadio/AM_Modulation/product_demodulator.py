...
class product_demodulator(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Product Demodulator", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Product Demodulator")
        ...
        self.settings = Qt.QSettings("GNU Radio", "product_demodulator")
        ...
        self._filter_cutoff_range = Range(1e3, 50e3, 1e3, 50e3, 200)
        self._filter_cutoff_win = RangeWidget(self._filter_cutoff_range, self.set_filter_cutoff, "Filter CutOff", "counter_slider", float, QtCore.Qt.Horizontal)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.filter_cutoff, 100, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=product_demodulator, options=None):
