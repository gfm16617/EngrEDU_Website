...
class voice_example(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lecture: AM with Voice", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lecture: AM with Voice")
        ...
        self.settings = Qt.QSettings("GNU Radio", "voice_example")
        ...
        # Blocks
        ##################################################
        self._mic_gain_range = Range(0, 10, 0.1, 1, 200)
...
def main(top_block_cls=voice_example, options=None):
