...
class dsb_modulation(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AM Modulator (DSB)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AM Modulator (DSB)")
        ...
        self.settings = Qt.QSettings("GNU Radio", "dsb_modulation")
...
def main(top_block_cls=dsb_modulation, options=None):
