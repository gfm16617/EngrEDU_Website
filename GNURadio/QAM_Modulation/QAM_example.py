...
class QAM_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "QAM Example", catch_exceptions=True)
        ...
        self.constel = constel = digital.constellation_16qam().base()
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps, 0.063, rrc_taps, 32, 16, 1.5, 1)
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 256, 200))), True)
