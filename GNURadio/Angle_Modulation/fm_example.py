...
class fm_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "FM Example", catch_exceptions=True)
        ...
        # Variables
        ##################################################
        self.sensitivity = sensitivity = 0.01
        ...
        # Blocks
        ##################################################
        self._sensitivity_range = Range(0, 0.1, 0.01, 0.01, 200)
        self._sensitivity_win = RangeWidget(self._sensitivity_range, self.set_sensitivity, "Modulation Index (m)", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._sensitivity_win)
        self._offset_range = Range(0, 5, 0.5, 2, 200)
        ...
        labels = ['Modulated Signal', 'NC', 'Information Signal', 'NC', 'Signal 5',
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10, 1, 0, 0)
