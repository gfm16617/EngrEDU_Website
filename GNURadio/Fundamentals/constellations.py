...
class constellations(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Constellations", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "constellations")
        ...
        self.analog_const_source_x_0_1 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, i_value)
        self.analog_const_source_x_0_0_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, q_value)
        ...
        self.connect((self.analog_const_source_x_0_1, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_multiply_xx_0, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.blocks_multiply_xx_0_0, 1))
        self.connect((self.blocks_float_to_complex_0_0, 0), (self.blocks_throttle_0_0, 0))
    ...
    def set_q_value(self, q_value):
        ...
        self.analog_const_source_x_0_0_0.set_offset(self.q_value)
    ...
    def set_i_value(self, i_value):
        ...
        self.analog_const_source_x_0_1.set_offset(self.i_value)




def main(top_block_cls=constellations, options=None):
