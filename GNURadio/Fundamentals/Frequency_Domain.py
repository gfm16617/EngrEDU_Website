...
class Frequency_Domain(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Frequency Domain", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "Frequency_Domain")
...
def main(top_block_cls=Frequency_Domain, options=None):
