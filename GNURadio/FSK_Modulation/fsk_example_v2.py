...
class fsk_example_v2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FSK Example v2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FSK Example v2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fsk_example_v2")
        ...
        labels = ['Binary Information Signal', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f((1, 0, 1, 1, 1, 0), True, 1, [])
        ...
        self.connect((self.blocks_repeat_0, 0), (self.blocks_sub_xx_0, 1))
        self.connect((self.blocks_repeat_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
...
def main(top_block_cls=fsk_example_v2, options=None):
