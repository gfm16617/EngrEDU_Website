...
class fsk_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "FSK Example", catch_exceptions=True)
        ...
        self.bit_message = bit_message = 0
        ...
        self._bit_message_options = [0, 1]
        # Create the labels list
        self._bit_message_labels = ['0', '1']
        # Create the combo box
        # Create the radio buttons
        self._bit_message_group_box = Qt.QGroupBox("'bit_message'" + ": ")
        self._bit_message_box = Qt.QVBoxLayout()
        ...
        self._bit_message_button_group = variable_chooser_button_group()
        self._bit_message_group_box.setLayout(self._bit_message_box)
        for i, _label in enumerate(self._bit_message_labels):
            radio_button = Qt.QRadioButton(_label)
            self._bit_message_box.addWidget(radio_button)
            self._bit_message_button_group.addButton(radio_button, i)
        self._bit_message_callback = lambda i: Qt.QMetaObject.invokeMethod(self._bit_message_button_group, "updateButtonChecked", Qt.Q_ARG("int", self._bit_message_options.index(i)))
        self._bit_message_callback(self.bit_message)
        self._bit_message_button_group.buttonClicked[int].connect(
            lambda i: self.set_bit_message(self._bit_message_options[i]))
        self.top_layout.addWidget(self._bit_message_group_box)
        ...
        labels = ['Information Signal', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.analog_const_source_x_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, bit_message)
    ...
    def get_bit_message(self):
        return self.bit_message

    def set_bit_message(self, bit_message):
        self.bit_message = bit_message
        self._bit_message_callback(self.bit_message)
        self.analog_const_source_x_0.set_offset(self.bit_message)
